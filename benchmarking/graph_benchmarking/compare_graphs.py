...
class GraphComparator:
    ...
    def _print_report(self):
        ...
        print(f"   Density: {self.g1_name}={self.stats['g1']['density']:.12f}, {self.g2_name}={self.stats['g2']['density']:.12f}")
        print(f"   Avg Degree: {self.g1_name}={self.stats['g1']['degree']:.2f}, {self.g2_name}={self.stats['g2']['degree']:.2f}")
        print("")

        print("4. Node Entropy (Degree Distribution):")
        print(f"   Entropy: {self.g1_name}={self.stats['g1']['entropy']:.4f}, {self.g2_name}={self.stats['g2']['entropy']:.4f}")
        print("")
        ...
        print(f"   Unique Relation Types: {self.g1_name}={self.stats['g1']['relations']}, {self.g2_name}={self.stats['g2']['relations']}")
        ...
        print(f"   Unique POS Tags: {self.g1_name}={self.stats['g1']['pos_tags']}, {self.g2_name}={self.stats['g2']['pos_tags']}")
